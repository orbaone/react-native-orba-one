...
export default class App extends Component<{}, AppState> {
  ...
  componentDidMount = async () => {
    try {
      ...
      ]).setAppearance({ colorPrimary: '#0057ea', colorButtonPrimary: '#0057ea', colorTextPrimary: '#0057ea', colorButtonPrimaryPressed: '#2D75FA', enableDarkMode: true }).setExcludeDocument([OrbaOneDocuments.passport]).setExcludeCountry(['BR']).build();
